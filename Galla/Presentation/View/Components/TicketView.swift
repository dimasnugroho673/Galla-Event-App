...
extension NSTextAttachment {
  func setLeftImage(text: String, imageString: String, imageType: ImageTypeTextFieldEnum) -> NSMutableAttributedString {
    // Create Attachment
    ...
    if imageType == .named {
      ...
      imageAttachment.image = UIImage(systemName: imageString)?.withTintColor(UIColor(named: "color-background")!)
    ...
    let textAfterIcon = NSAttributedString(string: "  " + text, attributes: [.foregroundColor: UIColor(named: "color-background")!])
