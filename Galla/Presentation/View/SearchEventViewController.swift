...
class SearchEventViewController: UIViewController {
  ...
  func configureBinding() {
    ...
    searchEventViewModel.joinEventStatus.bind { status in
      if status {
...
extension SearchEventViewController: UpcomingEventCellDelegate {
  func joinEvent(uid: String) {
    searchEventViewModel.attemptJoinEvent(uid: uid)
  }
}
